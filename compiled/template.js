...
class Main extends _preact.Component {
  constructor(props) {
    ...
    _defineProperty(this, "renderItems", () => {
      ...
      if (adjustment != 0 || order.adjustment_description) $adjustment = (0, _preact.h)("div", null, (0, _preact.h)("div", {
        style: "margin-top: 5px",
        title: this.props.t('adjustment_desc')
      }, this.props.t('adjustment')), (0, _preact.h)("div", {
      ...
      return (0, _preact.h)("div", {
        ...
        style: `font-family: ${template.number_font_family}`
      }, util.formatNumber(subtotal))), (0, _preact.h)("div", {
        style: "display: flex; justify-content: space-between; align-items: center"
      }, (0, _preact.h)("div", {
        style: "flex-shrink: 0"
      }, this.props.t('discount'), "\xA0"), (0, _preact.h)("div", {
        style: `font-family: ${template.number_font_family}`
      }, discount)), $ship, this.renderOrderTax(), $adjustment, (0, _preact.h)("div", {
        style: "display: flex; justify-content: space-between;align-items: center; margin-top: 5px; margin-bottom: 10px"
      }, (0, _preact.h)("b", null, this.props.t('total')), (0, _preact.h)("div", {
    ...
    _defineProperty(this, "renderOrderTax", () => {
      ...
      if (Object.keys(priceM).length === 0) return (0, _preact.h)("div", {
        style: "display: flex; justify-content: space-between;"
    ...
    _defineProperty(this, "renderPrintOverview", () => {
      ...
      }, this.props.t('order_number')), "\xA0", (0, _preact.h)("div", {
        style: "width: 100px"
      }, order.number || order.id)), (0, _preact.h)("div", {
        style: "display: flex;"
      }, (0, _preact.h)("div", {
        class: "invoice_sublabel"
      }, this.props.t('invoice_date')), "\xA0", (0, _preact.h)("div", {
        style: "width: 100px"
      }, util.formatDate(order.invoice_date || order.created || Date.now(), 'yyyy/MM/dd'))), (0, _preact.h)("div", {
        style: "display:flex"
      }, (0, _preact.h)("div", {
        class: "invoice_sublabel"
      }, this.props.t('due_date')), "\xA0", (0, _preact.h)("div", {
        style: "width: 100px"
      }, util.formatDate(order.due_date || order.invoice_date || order.created || Date.now(), 'yyyy/MM/dd'))), (0, _preact.h)("div", {
        style: "display: flex"
      }, (0, _preact.h)("div", {
        class: "invoice_sublabel"
      }, this.props.t('balance_due')), "\xA0", (0, _preact.h)("div", {
