...
var accounting = __webpack_require__(103);
...
class Main extends b {
  ...
  render() {
    ...
    }, y("style", null, gstyle), y("div", {
      class: "page_section",
      style: "padding: 0px 2cm;"
    }, this.renderHeader()), y("div", {
      class: "page_section",
      style: "padding: 0 2cm;"
    }, this.renderPrintOverview()), this.renderItems(), y("div", {
      class: "page_section",
      style: "padding: 0 2cm;"
    }, this.renderPaymentMethod()), y("div", {
      class: "page_section",
      style: "padding: 0 2cm;"
    }, this.renderTerms()), y("div", {
      class: "page_section",
      style: "padding: 0 2cm;"
  ...
  renderPaymentMethod = () => {
    ...
    let $method = y("div", null, this.props.t('no_information'));
    if (method.method === 'cash') {
      $method = y("div", null, this.props.t(`payment_method_cod`));
    } else if (method.method === 'bank_transfer') {
      $method = y("div", null, this.props.t(`payment_method_bank_transfer`));
    }
    return y("div", {
  ...
  renderItems = () => {
    ...
    }, this.props.t('product')), y("th", {
      style: "width: 100px; text-align: right"
    }, this.props.t('price')), y("th", {
      style: "width: 50px; text-align: center"
    }, this.props.t('qty')), y("th", {
    ...
    if (adjustment != 0 || order.adjustment_description) $adjustment = y("div", {
      style: "align-items: center; display: flex; justify-content: space-between;"
    }, y("div", {
      style: "width: 140px"
    }, order.adjustment_description || y("span", {
      style: "color: #888"
    }, this.props.t('empty'))), y("div", {
    ...
    if (order.shipping) {
      $ship = y("div", {
        ...
        class: "text-truncate"
      }, this.props.t('shipping_fee')), y("div", {
        style: `font-family: ${template.number_font_family}`
    ...
    if (order.note) {
      ...
      }, y("div", null, this.props.t('note')), y("div", null, order.note));
    }
    let left = (order.total || 0) - (order.payment_made || 0);
    if (left <= 0) left = 0;
    let $discountbeforetax = null;
    if (discountbeforetax) {
      $discountbeforetax = y("div", {
        style: "display: flex; justify-content: space-between; align-items: center"
      }, y("div", {
        style: "flex-shrink: 0"
      }, this.props.t('discount_before_tax'), "\xA0"), y("div", {
        style: `font-family: ${template.number_font_family}`
    ...
    if (discount) {
      $discountaftertax = y("div", {
        style: "display: flex; justify-content: space-between; align-items: center"
      }, y("div", {
        style: "flex-shrink: 0"
      }, this.props.t('discount_after_tax'), "\xA0", discount_note), y("div", {
        style: `font-family: ${template.number_font_family}`
    ...
    return y("div", {
      ...
      style: "flex: 1"
    }), y("div", null, this.props.t('currency'), ": ", order.currency || acc.currency || 'VND')), y("div", null, y("table", {
      ...
      style: "display: flex; justify-content: space-between;"
    }, y("div", null, this.props.t('subtotal')), y("div", {
      style: `font-family: ${template.number_font_family}`
    }, formatNumber(subtotal))), $ship, y("div", {
      style: "display: flex; justify-content: space-between;"
    }, y("div", null, this.props.t('tax')), y("div", {
      style: `font-family: ${template.number_font_family}`
    }, formatNumber(order.total_tax))), $discountaftertax, $adjustment, y("div", {
      style: "display: flex; justify-content: space-between;align-items: center; margin-top: 15px;"
    }, y("b", {
      style: "font-size: 18px"
    }, this.props.t('total')), y("div", {
      style: `font-size: 18px; font-weight: 600;font-family: ${template.number_font_family}`
    }, formatNumber(total))), y("div", {
      style: "display: flex; justify-content: space-between; "
    }, y("div", null, this.props.t('paid_state')), y("div", {
      style: `font-family: ${template.number_font_family}`
    }, formatNumber(order.payment_made))), y("div", {
      style: "display: flex; justify-content: space-between; "
    }, y("div", null, this.props.t('balance_due')), y("div", {
  ...
  renderPrintOverview = () => {
    ...
    if (address) {
      ...
      }, this.props.t('shipping_to')), y("div", null, address));
    }
    let user = order.user || {};
    ...
    }, this.props.t('customer')), y("div", null, userdisplayname), y("div", null, phone), $shipping), y("div", {
      style: "flex: 1"
    }), y("div", {
      style: "display: flex; flex-direction: column; text-align: right"
    }, y("div", null, y("div", {
      class: "invoice_sublabel"
    }, this.props.t('invoice_date')), y("div", null, formatDate(order.invoice_date || order.created || Date.now(), 'yyyy/MM/dd'))), y("div", null, y("div", {
      class: "invoice_sublabel mt-1"
    }, this.props.t('due_date')), y("div", null, formatDate(order.due_date || order.invoice_date || order.created || Date.now(), 'yyyy/MM/dd'))), y("div", {
      style: "flex: 1"
    })));
  };
  renderHeader = () => {
    ...
    }, "\xA0\xA0|\xA0\xA0", this.props.t.i18n(template.i18n_tagline, template.tagline))), y("div", {
      style: "font-size: 13px; color: #888; margin-top: 0px"
    }, acc.address, "\xA0\xA0\xB7\xA0\xA0", this.props.t('phn'), ":\xA0", acc.phone)))), y("div", {
...
const ajax = __webpack_require__(616);
